...
class AdminService implements AdminServiceInterface
{
    ...
    {
        $dataArray = Admin::query()->orderBy('id', 'desc')->paginate($limit, ['*'], 'page', $page);
        return Send::sendSuccess(200, 'success', ['list' => collect($dataArray->items())->toArray(), 'total' => $dataArray['total']]);
    }
}